...
{
    public partial class azWorkshopSqldbContext : DbContext
    {
        public azWorkshopSqldbContext()
        {
        }

        public azWorkshopSqldbContext(DbContextOptions<azWorkshopSqldbContext> options)
            : base(options)
        {
        }
